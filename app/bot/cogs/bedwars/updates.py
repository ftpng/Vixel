...
class BedwarsUpdates(commands.Cog):
    ...
    async def update_message(self):
        try:
            for mode, leaderboards in lib.BEDWARS_LEADERBOARDS.items():
            ...
            import traceback
            print(f"An error occurred in leaderboard updates: {e}")
            traceback.print_exc()
...
async def setup(client: commands.Bot):
    await client.add_cog(BedwarsUpdates(client))